...
<h3 align="center">Full Stack Developer | Backend Engineer | Systems Programming Enthusiast</h3>
...
### 🌟 Featured Projects
- HTTP Server in C (low-level socket programming)  
- Real-Time Chat App (WebSockets + React)  
- Expense Splitter Web App (Node.js + MongoDB)  
- Java CLI ToDo Backend with persistent storage  
...
### 🎯 Current Focus
Building backend systems, exploring networking internals, and writing efficient low-level software.
